<nav x-data="{ open: false }" class="dark:bg-slate-900 dark:text-white">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8  ">
        ...
        <div class="flex justify-center items-center gap-10">
            ...
            <div class="flex justify-center items-center ">
                <button class="grid place-items-center text-slate-100 p-2 toggle-dark bg-slate-600  rounded dark:bg-white dark:text-slate-800"><i class="fa-solid fa-circle-half-stroke"></i></button>
            </div>
